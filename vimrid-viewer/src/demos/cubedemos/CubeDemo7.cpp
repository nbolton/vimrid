...
CubeDemo7::CubeDemo7(VimridSettings &settings)
	: GlutApplication(settings)
{
	Title = "ViMRID Test Cube - v7 - 22/02/09";
...
void CubeDemo7::drawStereoEyeView(GLenum eyeBuffer)
{
	...
	// Focus camera on feature (camera moves, but feature never does).
	gluLookAt(
			CameraPoint.X * .1,
			CameraPoint.Y * .1,
			CameraPoint.Z * .1,
